...
int main(int argc, char *argv[])
{
	...
	// std::cout << "The source of the line(6) is : " << std::endl;	//由于add_gate()中，将新增加的门的索引赋值给输出线的源。所以六号线（G23gat）的source是对应的门（xor）的索引,也就是5
	...
	std::set<gate_idx> line_to_desination = graph.line(2).destination_gates;//输入线的目的gate对应的index
